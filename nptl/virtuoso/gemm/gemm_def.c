...
void *gemm_invoke(void *a) {
#ifdef DO_PER_INVOKE
    struct cpu_invoke_args_t *args = (struct cpu_invoke_args_t *) a;
    struct physical_accel_t *accel = args->accel;
    ...
    struct physical_accel_t *accel = (struct physical_accel_t *) a;
    struct cpu_invoke_args_t *args = accel->args;
